...
identificeer u uw zelf als een man of een vrouw

Hebben ze net een fysieke activiteit gehad.

Drinken ze regelmatig cafeïne/hebben ze vandaag cafeïne gehad.

Hebben ze hart- en vaatproblemen.
...
```{r}
# Data voor grafiek
naam <- c("R Markdown", "R", "ggplot2")
versie <- c('2.11', '4.1', '3.3.5')
referentie <- c("M", "V", "V")
doel <- c("Een opmaaktaal die R-code en tekst combineert voor rapporten en documentatie","Programmeertaal voor statistische analyse en visualisatie","Een krachtige R-bibliotheek voor datavisualisatie en grafieken")
...
file %>%
  mean(filter(vragenlijst == "caffeine"), na.rm = T)
