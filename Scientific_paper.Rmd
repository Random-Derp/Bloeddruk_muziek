...
```
Figuur 4: Op deze grafiek wordt er getoond hoe heftig de reactie op de muziek was als je caffeine hebt genomen die dag. Op de x-as 
...
anova <- aov(bpm_diff ~ sexe, data = file)
summary(anova)

voor <- file$boven_bloeddruk_voor
na <- file$boven_bloeddruk_na

t.test(voor, na, data = file, paired = TRUE)
```
