...
```
Figuur 1:In deze grafiek word weergegeven hoe erg de reactie van de hartslag op de muziek effect had. In het blauw hebben we de mannen en in het rood hebben we de vrouwen. De x-as heeft de sexe en de y-as heeft de bpm-diff, wat staat voor het verschil in bpm wat gemeten is, dus eerste metig - tweede meting. Als het boven nul is betekent het dat er een toename is geweest in hartslag bij de tweede meting, dus na de muziek, vergeleken met de eerste meting. Als hij juist onder nul zit betekent het dat er een afname was in bpm bij de tweede meting. In de grafiek valt duidelijk te zien dat de vrouwen gemiddeld een zwaardere reactie hebben op de muziek dan de mannen. Als wij ons resultaat vergelijken met een ander vergelijkbaar onderzoek (link) kun je zien dat de reactie op de drukke muziek een stuk minder heftig is vergeleken met het andere onderzoek. Ook zie je bij de jongens dat ze kalmeren van de drukke muziek inplaats van dat de hartslag stijgt. 
...
```
Figuur 2:In deze grafiek wordt het verschil tussen de twee metingen weergegeven van onder bloeddruk en boven bloeddruk. De x-as is de sexe en de y-as is de bloeddruk-diff. Er valt te zien dat bij de boven bloeddruk grafiek de mannen een grotere toename hebben in bloeddruk dan de vrouwen. De mannen zijn daarintegen ook meer verspreid dan de vrouwen. Bij de onder bloeddruk blijft het bij allebei ongeveer gelijk, maar gemiddeld gaat de onder bloeddruk wel een beetje omlaag. Hier zijn de mannen ook weer meer verspreid dan de vrouwen. Er is geen vergelijkbaar onderzoek die hier mee te vergelijken valt.
